...
namespace assignment8.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(assignment8Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publishers != null ? 
                          ...
                          Problem("Entity set 'assignment8Context.Publishers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'assignment8Context.Publishers'  is null.");
            }
            var publisher = await _context.Publishers.FindAsync(id);
            if (publisher != null)
            {
